              ...
              {[
                {
                  ...
                  description: "Confirm identity authenticity and ensure every candidate has legal authorisation to work in Malaysia. This protects you from compliance issues and fraudulent applications."
                },
                {
                  icon: ShieldAlert,
                  title: "Criminal Record Check (Local & International)",
                  description: "Identify any criminal history relevant to the role. We provide fast, verified insights for Malaysian citizens, permanent residents and foreign hires."
                },
                {
                  icon: Briefcase,
                  title: "Employment History Verification",
                  description: "Validate past job titles, responsibilities, company names and durations to ensure the candidate's work experience matches what they claim."
                },
                {
                  icon: GraduationCap,
                  title: "Education & Academic Qualification Check",
                  description: "Verify certificates, diplomas, university degrees and professional licenses obtained locally or overseas. Ideal for roles requiring certified skills or regulated qualifications."
                },
                {
                  icon: Users,
                  title: "Reference Check",
                  description: "Gain meaningful insights into work ethic, professionalism and performance through direct reference interviews."
                },
                {
                  icon: Globe,
                  title: "Global Sanctions & Watchlist Screening",
                  description: "Ensure candidates are not flagged on international sanctions, compliance watchlists or politically exposed person databases."
                },
                {
                  icon: CreditCard,
                  title: "Credit Check (Role Dependent)",
                  description: "For roles involving financial responsibility, credit checks help evaluate reliability and risk indicators."
                }
              ].map((check, index) => {
